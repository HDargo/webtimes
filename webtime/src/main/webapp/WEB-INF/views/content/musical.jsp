...
<body>
        ...
        <div class="row">
            <div class="main-show">
                <img src="../resources/img/musical/bg_musical.jpg">
                   <div class="img-wrap">
                    <dl class="main-img1">
                        <dt><a href="contentDetail?num=6"><img src="../resources/img/musical/mu_list6.gif"></a></dt>
                        <dd>
                    ...
                    <dl class="main-img2">
                        <dt><a href="contentDetail?num=7"><img src="../resources/img/musical/mu_list7.gif"></a></dt>
                        <dd>
                    ...
                    <dl class="main-img3">
                        <dt><a href="contentDetail?num=8"><img src="../resources/img/musical/mu_list8.gif"></a></dt>
                        <dd>
                    ...
                    <dl class="main-img4">
                        <dt><a href="contentDetail?num=9"><img src="../resources/img/musical/mu_list9.gif"></a></dt>
                        <dd>
                    ...
                    <dl class="main-img5">
                        <dt><a href="contentDetail?num=10"><img src="../resources/img/musical/mu_list10.gif"></a></dt>
                        <dd>
                    ...
                    <dl class="main-img6">
                        <dt><a href="contentDetail?num=11"><img src="../resources/img/musical/mu_list11.gif"></a></dt>
                        <dd>
                      ...
                      <c:forEach var="t_list" items="${ticketList }" end="4">
                        <dt class ="obj">
                            <a href="contentDetail?num=${t_list.num }">
                                <img src="../resources/img/musical/mu_list${t_list.num }.gif">
                            </a>
                            <p class="info">
 ...
 <%@include file="../include/footer.jsp" %>
      <script>
          ...
          var MuTopBanners = [
            ['../resources/img/musical/b_musical1.gif', 'http://localhost:8181/webtime/content/contentDetail?num=12', '웃는남자'],
            ['../resources/img/musical/b_musical2.gif', 'http://localhost:8181/webtime/content/contentDetail?num=13', '보디가드'],
            ['../resources/img/musical/b_musical3.gif', 'http://localhost:8181/webtime/content/contentDetail?num=14', '스웨그에이지'],
            ['../resources/img/musical/b_musical4.gif', 'http://localhost:8181/webtime/content/contentDetail?num=15', '경종수정실록'],
            ['../resources/img/musical/b_musical5.gif', 'http://localhost:8181/webtime/content/contentDetail?num=3', '뮤지컬스타 빅4'],
            ['../resources/img/musical/b_musical6.gif', 'http://localhost:8181/webtime/content/contentDetail?num=16', '레베카']
          ];
