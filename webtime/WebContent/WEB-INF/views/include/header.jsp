                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu menu-drop">
                                        <li class="theme-btn"><a href="${pageContext.request.contextPath}/content/sports/sports_main">스포츠</a></li>
                                        <li><a href="#">야구</a></li>
                                        <li><a href="#">배구</a></li>
                                        <li><a href="#">측구</a></li>
                                        <li><a href="#">농구</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu menu-drop">
                                        <li class="theme-btn"><a href="${pageContext.request.contextPath}/content/leisure">레저</a></li>
                                        <li><a href="#">제주도</a></li>
